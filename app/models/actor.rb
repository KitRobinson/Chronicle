class Actor < ActiveRecord::Base
	...
	def report_definition
		report_def = {
			...
			might: {difficulty: 50, approximator: "descriptive", field_name:"might", max_datum:6},
			will: {difficulty: 50, approximator: "descriptive", field_name:"will", max_datum:6},
			cunning: {difficulty: 50, approximator: "descriptive", field_name:"cunning", max_datum:6},
			subtlety: {difficulty: 50, approximator: "descriptive", field_name:"subtlety", max_datum:6},
			perception: {difficulty: 50, approximator: "descriptive", field_name:"perception", max_datum:6},
			sagacity: {difficulty: 50, approximator: "descriptive", field_name:"sagacity", max_datum:6},
