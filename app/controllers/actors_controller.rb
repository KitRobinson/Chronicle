class ActorsController < ApplicationController
  ...
  private
    ...
    def actor_params
      params.require(:actor).permit(:name, :description, :race_id, :might, :will, :cunning, :subtlety, :perception, :sagacity, :province_id, :organization_id, :scale, :count, :personality, :mood)
    end
end
