...
class TerrainsControllerTest < ActionController::TestCase
  ...
  test "should create terrain" do
    assert_difference('Terrain.count') do
      post :create, terrain: { development_multiplier: @terrain.development_multiplier, difficulty: @terrain.difficulty, name: @terrain.name }
    end
  ...
  test "should update terrain" do
    patch :update, id: @terrain, terrain: { development_multiplier: @terrain.development_multiplier, difficulty: @terrain.difficulty, name: @terrain.name }
    assert_redirected_to terrain_path(assigns(:terrain))
  end
