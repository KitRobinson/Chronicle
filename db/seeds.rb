...
Province.find(2).update(name:"noname", primary_terrain: Terrain.where(name: "Mud").first, secondary_terrain: Terrain.where(name: "Coast").first )
Province.find(3).update(name:"noname", primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Rocky").first )
Province.find(4).update(name:"noname", primary_terrain: Terrain.where(name: "Coast").first, secondary_terrain: Terrain.where(name: "Dirt").first )
Province.find(5).update(name:"noname", primary_terrain: Terrain.where(name: "Coast").first, secondary_terrain: Terrain.where(name: "Dirt").first )
...
Province.find(7).update(name:"noname", primary_terrain: Terrain.where(name: "Coast").first, secondary_terrain: Terrain.where(name: "Dirt").first )
Province.find(8).update(name:"noname", primary_terrain: Terrain.where(name: "Coast").first, secondary_terrain: Terrain.where(name: "Rocky").first )
Province.find(9).update(name:"noname", primary_terrain: Terrain.where(name: "Coast").first, secondary_terrain: Terrain.where(name: "Dirt").first )
Province.find(10).update(name:"noname", primary_terrain: Terrain.where(name: "Mountains").first, secondary_terrain: Terrain.where(name: "Mountains").first )
Province.find(11).update(name:"noname", primary_terrain: Terrain.where(name: "Mountains").first, secondary_terrain: Terrain.where(name: "Mountains").first )
Province.find(12).update(name:"noname", primary_terrain: Terrain.where(name: "Mountain Pass").first, secondary_terrain: Terrain.where(name: "Mountain").first )
Province.find(13).update(name:"noname", primary_terrain: Terrain.where(name: "Mountain Pass").first, secondary_terrain: Terrain.where(name: "Mountain").first )
Province.find(14).update(name:"noname", primary_terrain: Terrain.where(name: "Rocky").first, secondary_terrain: Terrain.where(name: "Dirt").first )
...
Province.find(17).update(name:"noname", primary_terrain: Terrain.where(name: "Coast").first, secondary_terrain: Terrain.where(name: "Dirt").first )
...
Province.find(20).update(name:"noname", primary_terrain: Terrain.where(name: "Coast").first, secondary_terrain: Terrain.where(name: "Hills").first )
Province.find(21).update(name:"noname", primary_terrain: Terrain.where(name: "Rocky").first, secondary_terrain: Terrain.where(name: "River").first )
Province.find(22).update(name:"noname", primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "River").first )
Province.find(23).update(name:"noname", primary_terrain: Terrain.where(name: "Mountains").first, secondary_terrain: Terrain.where(name: "Mountains").first )
Province.find(24).update(name:"noname", primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Dirt").first )
Province.find(25).update(name:"noname", primary_terrain: Terrain.where(name: "Mud").first, secondary_terrain: Terrain.where(name: "Coast").first )
Province.find(26).update(name:"noname", primary_terrain: Terrain.where(name: "Mud").first, secondary_terrain: Terrain.where(name: "Coast").first )
Province.find(27).update(name:"noname", primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Coast").first )
Province.find(28).update(name:"noname", primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Rocky").first )
Province.find(29).update(name:"noname", primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Rocky").first )
...
Province.find(31).update(name:"noname", primary_terrain: Terrain.where(name: "Mountains").first, secondary_terrain: Terrain.where(name: "Mountains").first )
Province.find(32).update(name:"noname", primary_terrain: Terrain.where(name: "Mountains").first, secondary_terrain: Terrain.where(name: "Mountains").first )
Province.find(33).update(name:"noname", primary_terrain: Terrain.where(name: "Mountains").first, secondary_terrain: Terrain.where(name: "Mountains").first )
...
Province.find(35).update(name:"noname", primary_terrain: Terrain.where(name: "Mountains").first, secondary_terrain: Terrain.where(name: "Hills").first )
Province.find(36).update(name:"noname", primary_terrain: Terrain.where(name: "Mountains").first, secondary_terrain: Terrain.where(name: "Mountains").first )
Province.find(37).update(name:"noname", primary_terrain: Terrain.where(name: "Mountain").first, secondary_terrain: Terrain.where(name: "Hills").first )
Province.find(38).update(name:"noname", primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Hills").first )
Province.find(39).update(name:"noname", primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Rocky").first )
Province.find(40).update(name:"noname", primary_terrain: Terrain.where(name: "Mountains").first, secondary_terrain: Terrain.where(name: "Hills").first )
Province.find(41).update(name:"noname", primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Dirt").first )
Province.find(42).update(name:"noname", primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Mud").first )
Province.find(43).update(name:"noname", primary_terrain: Terrain.where(name: "Grassland").first, secondary_terrain: Terrain.where(name: "Forest").first )
...
Province.find(45).update(name:"noname", primary_terrain: Terrain.where(name: "Mud").first, secondary_terrain: Terrain.where(name: "Dirt").first )
...
Province.find(47).update(name:"noname", primary_terrain: Terrain.where(name: "Elysian").first, secondary_terrain: Terrain.where(name: "Hills").first )
Province.find(48).update(name:"noname", primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Hills").first )
Province.find(49).update(name:"noname", primary_terrain: Terrain.where(name: "Rocky").first, secondary_terrain: Terrain.where(name: "Hills").first )
Province.find(50).update(name:"noname", primary_terrain: Terrain.where(name: "Hills").first, secondary_terrain: Terrain.where(name: "River").first )
Province.find(51).update(name:"noname", primary_terrain: Terrain.where(name: "Rocky").first, secondary_terrain: Terrain.where(name: "Coast").first )
Province.find(52).update(name:"noname", primary_terrain: Terrain.where(name: "Rocky").first, secondary_terrain: Terrain.where(name: "Coast").first )
Province.find(53).update(name:"noname", primary_terrain: Terrain.where(name: "Coast").first, secondary_terrain: Terrain.where(name: "Dirt").first )
Province.find(54).update(name:"noname", primary_terrain: Terrain.where(name: "Coast").first, secondary_terrain: Terrain.where(name: "Dirt").first )
Province.find(55).update(name:"noname", primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Coast").first )
Province.find(56).update(name:"noname", primary_terrain: Terrain.where(name: "Coast").first, secondary_terrain: Terrain.where(name: "Mud").first )
Province.find(57).update(name:"noname", primary_terrain: Terrain.where(name: "Mud").first, secondary_terrain: Terrain.where(name: "Coast").first )
Province.find(58).update(name:"noname", primary_terrain: Terrain.where(name: "Rocky").first, secondary_terrain: Terrain.where(name: "Coast").first )
Province.find(59).update(name:"noname", primary_terrain: Terrain.where(name: "Rocky").first, secondary_terrain: Terrain.where(name: "Hills").first )
Province.find(60).update(name:"noname", primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Hills").first )
Province.find(61).update(name:"noname", primary_terrain: Terrain.where(name: "Coast").first, secondary_terrain: Terrain.where(name: "Rocky").first )
Province.find(62).update(name:"noname", primary_terrain: Terrain.where(name: "Mud").first, secondary_terrain: Terrain.where(name: "Coast").first )
Province.find(63).update(name:"noname", primary_terrain: Terrain.where(name: "Hills").first, secondary_terrain: Terrain.where(name: "Plains").first )
Province.find(64).update(name:"noname", primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Rocky").first )
Province.find(65).update(name:"noname", primary_terrain: Terrain.where(name: "Hills").first, secondary_terrain: Terrain.where(name: "Rocky").first )
Province.find(66).update(name:"noname", primary_terrain: Terrain.where(name: "Hills").first, secondary_terrain: Terrain.where(name: "Dirt").first )
Province.find(67).update(name:"noname", primary_terrain: Terrain.where(name: "Rocky").first, secondary_terrain: Terrain.where(name: "River").first )
Province.find(68).update(name:"noname", primary_terrain: Terrain.where(name: "Rocky").first, secondary_terrain: Terrain.where(name: "Hills").first )
Province.find(69).update(name:"noname", primary_terrain: Terrain.where(name: "Rocky").first, secondary_terrain: Terrain.where(name: "River").first )
Province.find(70).update(name:"noname", primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Hills").first )
Province.find(71).update(name:"noname", primary_terrain: Terrain.where(name: "Lake").first, secondary_terrain: Terrain.where(name: "Dirt").first )
Province.find(72).update(name:"noname", primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Dirt").first )
Province.find(73).update(name:"noname", primary_terrain: Terrain.where(name: "Hills").first, secondary_terrain: Terrain.where(name: "River").first )
Province.find(74).update(name:"noname", primary_terrain: Terrain.where(name: "Rocky").first, secondary_terrain: Terrain.where(name: "River").first )
Province.find(75).update(name:"noname", primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Mud").first )
Province.find(76).update(name:"noname", primary_terrain: Terrain.where(name: "Mud").first, secondary_terrain: Terrain.where(name: "Lake").first )
Province.find(77).update(name:"noname", primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Rocky").first )
Province.find(78).update(name:"noname", primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Coast").first )
Province.find(79).update(name:"noname", primary_terrain: Terrain.where(name: "Coast").first, secondary_terrain: Terrain.where(name: "Elysian").first )
Province.find(80).update(name:"noname", primary_terrain: Terrain.where(name: "Rocky").first, secondary_terrain: Terrain.where(name: "River").first )
Province.find(81).update(name:"noname", primary_terrain: Terrain.where(name: "Mud").first, secondary_terrain: Terrain.where(name: "Coast").first )
Province.find(82).update(name:"noname", primary_terrain: Terrain.where(name: "Rocky").first, secondary_terrain: Terrain.where(name: "Coast").first )
Province.find(83).update(name:"noname", primary_terrain: Terrain.where(name: "Rocky").first, secondary_terrain: Terrain.where(name: "Dirt").first )
Province.find(84).update(name:"noname", primary_terrain: Terrain.where(name: "Rocky").first, secondary_terrain: Terrain.where(name: "Dirt").first )
Province.find(85).update(name:"noname", primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Coast").first )
...
Province.find(87).update(name:"noname", primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Coast").first )
Province.find(88).update(name:"noname", primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Rocky").first )
Province.find(89).update(name:"noname", primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(90).update(name:"noname", primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(91).update(name:"noname", primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(92).update(name:"noname", primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(93).update(name:"noname", primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(94).update(name:"noname", primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(95).update(name:"noname", primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(96).update(name:"noname", primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(97).update(name:"noname", primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(98).update(name:"noname", primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(99).update(name:"noname", primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(100).update(name:"noname", primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(101).update(name:"noname", primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(102).update(name:"noname", primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(103).update(name:"noname", primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(104).update(name:"noname", primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(105).update(name:"noname", primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(106).update(name:"noname", primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(107).update(name:"noname", primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Hills").first )
Province.find(108).update(name:"noname", primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
Province.find(109).update(name:"noname", primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
Province.find(110).update(name:"noname", primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
Province.find(111).update(name:"noname", primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
Province.find(112).update(name:"noname", primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
Province.find(113).update(name:"noname", primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
Province.find(114).update(name:"noname", primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
Province.find(115).update(name:"noname", primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
Province.find(116).update(name:"noname", primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
Province.find(117).update(name:"noname", primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
Province.find(118).update(name:"noname", primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
Province.find(119).update(name:"noname", primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
Province.find(120).update(name:"noname", primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
Province.find(121).update(name:"noname", primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
Province.find(122).update(name:"noname", primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
Province.find(123).update(name:"noname", primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
