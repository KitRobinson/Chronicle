...
Province.find(27).update(primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Coast").first )
Province.find(55).update(primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Coast").first )
Province.find(78).update(primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Coast").first )
Province.find(85).update(primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Coast").first )
Province.find(87).update(primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Coast").first )
Province.find(2).update(primary_terrain: Terrain.where(name: "Mud").first, secondary_terrain: Terrain.where(name: "Coast").first )
Province.find(25).update(primary_terrain: Terrain.where(name: "Mud").first, secondary_terrain: Terrain.where(name: "Coast").first )
Province.find(26).update(primary_terrain: Terrain.where(name: "Mud").first, secondary_terrain: Terrain.where(name: "Coast").first )
Province.find(57).update(primary_terrain: Terrain.where(name: "Mud").first, secondary_terrain: Terrain.where(name: "Coast").first )
Province.find(62).update(primary_terrain: Terrain.where(name: "Mud").first, secondary_terrain: Terrain.where(name: "Coast").first )
Province.find(81).update(primary_terrain: Terrain.where(name: "Mud").first, secondary_terrain: Terrain.where(name: "Coast").first )
Province.find(51).update(primary_terrain: Terrain.where(name: "Rocky").first, secondary_terrain: Terrain.where(name: "Coast").first )
Province.find(52).update(primary_terrain: Terrain.where(name: "Rocky").first, secondary_terrain: Terrain.where(name: "Coast").first )
Province.find(58).update(primary_terrain: Terrain.where(name: "Rocky").first, secondary_terrain: Terrain.where(name: "Coast").first )
Province.find(82).update(primary_terrain: Terrain.where(name: "Rocky").first, secondary_terrain: Terrain.where(name: "Coast").first )
Province.find(4).update(primary_terrain: Terrain.where(name: "Coast").first, secondary_terrain: Terrain.where(name: "Dirt").first )
Province.find(5).update(primary_terrain: Terrain.where(name: "Coast").first, secondary_terrain: Terrain.where(name: "Dirt").first )
Province.find(7).update(primary_terrain: Terrain.where(name: "Coast").first, secondary_terrain: Terrain.where(name: "Dirt").first )
Province.find(9).update(primary_terrain: Terrain.where(name: "Coast").first, secondary_terrain: Terrain.where(name: "Dirt").first )
Province.find(17).update(primary_terrain: Terrain.where(name: "Coast").first, secondary_terrain: Terrain.where(name: "Dirt").first )
Province.find(53).update(primary_terrain: Terrain.where(name: "Coast").first, secondary_terrain: Terrain.where(name: "Dirt").first )
Province.find(54).update(primary_terrain: Terrain.where(name: "Coast").first, secondary_terrain: Terrain.where(name: "Dirt").first )
Province.find(79).update(primary_terrain: Terrain.where(name: "Coast").first, secondary_terrain: Terrain.where(name: "Dirt").first )
Province.find(24).update(primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Dirt").first )
Province.find(41).update(primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Dirt").first )
Province.find(72).update(primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Dirt").first )
Province.find(66).update(primary_terrain: Terrain.where(name: "Hills").first, secondary_terrain: Terrain.where(name: "Dirt").first )
Province.find(71).update(primary_terrain: Terrain.where(name: "Lake").first, secondary_terrain: Terrain.where(name: "Dirt").first )
Province.find(45).update(primary_terrain: Terrain.where(name: "Mud").first, secondary_terrain: Terrain.where(name: "Dirt").first )
Province.find(14).update(primary_terrain: Terrain.where(name: "Rocky").first, secondary_terrain: Terrain.where(name: "Dirt").first )
Province.find(83).update(primary_terrain: Terrain.where(name: "Rocky").first, secondary_terrain: Terrain.where(name: "Dirt").first )
Province.find(84).update(primary_terrain: Terrain.where(name: "Rocky").first, secondary_terrain: Terrain.where(name: "Dirt").first )
Province.find(43).update(primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Rocky").first )
...
Province.find(108).update(primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
Province.find(109).update(primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
Province.find(110).update(primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
Province.find(111).update(primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
Province.find(112).update(primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
Province.find(113).update(primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
Province.find(114).update(primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
Province.find(115).update(primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
Province.find(116).update(primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
Province.find(117).update(primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
Province.find(118).update(primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
Province.find(119).update(primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
Province.find(120).update(primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
Province.find(121).update(primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
Province.find(122).update(primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
Province.find(123).update(primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
...
Province.find(20).update(primary_terrain: Terrain.where(name: "Coast").first, secondary_terrain: Terrain.where(name: "Hills").first )
Province.find(38).update(primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Hills").first )
Province.find(48).update(primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Hills").first )
Province.find(60).update(primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Hills").first )
Province.find(70).update(primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Hills").first )
Province.find(47).update(primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Hills").first )
Province.find(35).update(primary_terrain: Terrain.where(name: "Mountains").first, secondary_terrain: Terrain.where(name: "Hills").first )
Province.find(37).update(primary_terrain: Terrain.where(name: "Mountains").first, secondary_terrain: Terrain.where(name: "Hills").first )
Province.find(40).update(primary_terrain: Terrain.where(name: "Mountains").first, secondary_terrain: Terrain.where(name: "Hills").first )
Province.find(107).update(primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Hills").first )
Province.find(49).update(primary_terrain: Terrain.where(name: "Rocky").first, secondary_terrain: Terrain.where(name: "Hills").first )
Province.find(59).update(primary_terrain: Terrain.where(name: "Rocky").first, secondary_terrain: Terrain.where(name: "Hills").first )
Province.find(68).update(primary_terrain: Terrain.where(name: "Rocky").first, secondary_terrain: Terrain.where(name: "Hills").first )
...
Province.find(76).update(primary_terrain: Terrain.where(name: "Mud").first, secondary_terrain: Terrain.where(name: "Lake").first )
Province.find(12).update(primary_terrain: Terrain.where(name: "Mountain Pass").first, secondary_terrain: Terrain.where(name: "Mountains").first )
Province.find(13).update(primary_terrain: Terrain.where(name: "Mountain Pass").first, secondary_terrain: Terrain.where(name: "Mountains").first )
Province.find(10).update(primary_terrain: Terrain.where(name: "Mountains").first, secondary_terrain: Terrain.where(name: "Mountains").first )
Province.find(11).update(primary_terrain: Terrain.where(name: "Mountains").first, secondary_terrain: Terrain.where(name: "Mountains").first )
Province.find(23).update(primary_terrain: Terrain.where(name: "Mountains").first, secondary_terrain: Terrain.where(name: "Mountains").first )
Province.find(31).update(primary_terrain: Terrain.where(name: "Mountains").first, secondary_terrain: Terrain.where(name: "Mountains").first )
Province.find(32).update(primary_terrain: Terrain.where(name: "Mountains").first, secondary_terrain: Terrain.where(name: "Mountains").first )
Province.find(33).update(primary_terrain: Terrain.where(name: "Mountains").first, secondary_terrain: Terrain.where(name: "Mountains").first )
...
Province.find(36).update(primary_terrain: Terrain.where(name: "Mountains").first, secondary_terrain: Terrain.where(name: "Mountains").first )
Province.find(56).update(primary_terrain: Terrain.where(name: "Coast").first, secondary_terrain: Terrain.where(name: "Mud").first )
Province.find(42).update(primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Mud").first )
Province.find(75).update(primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Mud").first )
Province.find(89).update(primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(90).update(primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(91).update(primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(92).update(primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(93).update(primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(94).update(primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(95).update(primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(96).update(primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(97).update(primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(98).update(primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(99).update(primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(100).update(primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(101).update(primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(102).update(primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(103).update(primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(104).update(primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
...
Province.find(50).update(primary_terrain: Terrain.where(name: "Hills").first, secondary_terrain: Terrain.where(name: "River").first )
Province.find(73).update(primary_terrain: Terrain.where(name: "Hills").first, secondary_terrain: Terrain.where(name: "River").first )
Province.find(21).update(primary_terrain: Terrain.where(name: "Rocky").first, secondary_terrain: Terrain.where(name: "River").first )
Province.find(67).update(primary_terrain: Terrain.where(name: "Rocky").first, secondary_terrain: Terrain.where(name: "River").first )
Province.find(69).update(primary_terrain: Terrain.where(name: "Rocky").first, secondary_terrain: Terrain.where(name: "River").first )
Province.find(74).update(primary_terrain: Terrain.where(name: "Rocky").first, secondary_terrain: Terrain.where(name: "River").first )
Province.find(80).update(primary_terrain: Terrain.where(name: "Rocky").first, secondary_terrain: Terrain.where(name: "River").first )
...
Province.find(8).update(primary_terrain: Terrain.where(name: "Coast").first, secondary_terrain: Terrain.where(name: "Rocky").first )
Province.find(61).update(primary_terrain: Terrain.where(name: "Coast").first, secondary_terrain: Terrain.where(name: "Rocky").first )
Province.find(3).update(primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Rocky").first )
Province.find(28).update(primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Rocky").first )
Province.find(29).update(primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Rocky").first )
Province.find(39).update(primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Rocky").first )
Province.find(64).update(primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Rocky").first )
Province.find(77).update(primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Rocky").first )
