...
Province.find(32).update(suzerain: goblin_nation[0])
Province.find(33).update(suzerain: goblin_nation[0])
Province.find(34).update(suzerain: goblin_nation[0])
Province.find(36).update(suzerain: goblin_nation[0])
Province.find(13).update(suzerain: goblin_nation[0])
...
Province.find(18).update(suzerain: ashanti[0])
Province.find(19).update(suzerain: ashanti[0])
...
Province.find(46).update(suzerain: urd[0])
Province.find(34).update(suzerain: urd[0])
Province.find(44).update(suzerain: urd[0])
...
Province.find(52).update(suzerain: akatian_cities[0])
Province.find(53).update(suzerain: akatian_cities[0])
...
Province.find(30).update(suzerain: backvale[0])
# --------------------------------------------
