...
u = User.create(username: '???', email: 'arureo@gmail.com', password: 'Aiden', access: 1)
d = Deity.create(name: '???', user: u)

u = User.create(username: 'Dartha', email: 'absrubydev@gmail.com', password: 'Lampshade1', access: 1)
d = Deity.create(name: 'Dartha', user: u)

u = User.create(username: 'Ehlisfaire', email: 'bittiersylph@gmail.con', password: 'LoveYouBabe', access: 1)
d = Deity.create(name: 'Ehlisfaire', user: u)

u = User.create(username: 'Gawp', email: 'dahiaka@dahiaka.com', password: 'WISDOMOFTHEPOG', access: 1)
d = Deity.create(name: 'Gawp', user: u)

u = User.create(username: 'Harkates', email: 'wpatrickwade@gmail.com', password: 'SkogarEncryptsThings', access: 2)
d = Deity.create(name: 'Harkates', user: u)

u = User.create(username: 'Krolos', email: 'karldbradley@gmail.com', password: 'WineIsFine', access: 1)
d = Deity.create(name: 'Krolos', user: u)

u = User.create(username: 'Larswoha', email: 'millerandrew.ny@gmail.com', password: 'RatOgre', access: 1)
d = Deity.create(name: 'Larswoha', user: u)

u = User.create(username: 'Luogh', email: 'xaoschild@gmail.com', password: 'Spear', access: 1)
d = Deity.create(name: 'Luogh', user: u)

u = User.create(username: 'Ohm', email: 'maltodextrin@msn.com', password: "Lampshade1", access: 3)

u = User.create(username: 'Ordwyn', email: 'misternadolny@gmail.com', password: 'BossMan', access: 1)
d = Deity.create(name: 'Ordwyn', user: u)

u = User.create(username: 'Oscaro', email: 'tspencest@gmail.com', password: 'Census2010', access: 1)
d = Deity.create(name: 'Oscaro', user: u)

u = User.create(username: 'Skaal', email: 'anonymous@notanemail.com', password: 'WISDOMOFTHEPOG', access: 1)
d = Deity.create(name: 'Skaal', user: u)

u = User.create(username: 'Ululantibus', email: 'jeff.wachall@gmail.com', password: 'LarsPerianderSolon', access: 1)
d = Deity.create(name: 'Ululantibus', user: u)

u = User.create(username: 'Vaniya', email: 'chickmcgovern@gmail.com', password: 'Lampshade1', access: 1)
d = Deity.create(name: 'Vaniya', user: u)

u = User.create(username: 'Zephyrus', email: 'mmaggio@uchicago.edu', password: 'Vivian', access: 1)
d = Deity.create(name: 'Zephyrus', user: u)
