...
Province.find(1).update(name:"The Pirate Isles", primary_terrain: Terrain.where(name: "Coast").first, secondary_terrain: Terrain.where(name: "Rocky").first )
Province.find(2).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Mud").first, secondary_terrain: Terrain.where(name: "Coast").first )
Province.find(3).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Rocky").first )
Province.find(4).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Coast").first, secondary_terrain: Terrain.where(name: "Dirt").first )
Province.find(5).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Coast").first, secondary_terrain: Terrain.where(name: "Dirt").first )
Province.find(6).update(name:"Greater and Lesser Turtles", primary_terrain: Terrain.where(name: "Coast").first, secondary_terrain: Terrain.where(name: "Hills").first )
Province.find(7).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Coast").first, secondary_terrain: Terrain.where(name: "Dirt").first )
Province.find(8).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Coast").first, secondary_terrain: Terrain.where(name: "Rocky").first )
Province.find(9).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Coast").first, secondary_terrain: Terrain.where(name: "Dirt").first )
Province.find(10).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Mountains").first, secondary_terrain: Terrain.where(name: "Mountains").first )
Province.find(11).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Mountains").first, secondary_terrain: Terrain.where(name: "Mountains").first )
Province.find(12).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Mountain Pass").first, secondary_terrain: Terrain.where(name: "Mountain").first )
Province.find(13).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Mountain Pass").first, secondary_terrain: Terrain.where(name: "Mountain").first )
Province.find(14).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Rocky").first, secondary_terrain: Terrain.where(name: "Dirt").first )
...
Province.find(17).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Coast").first, secondary_terrain: Terrain.where(name: "Dirt").first )
Province.find(18).update(name:"Windward Res Akhani", primary_terrain: Terrain.where(name: "Mountain").first, secondary_terrain: Terrain.where(name: "Res Akhani").first )
Province.find(19).update(name:"Leeward Res Akhani", primary_terrain: Terrain.where(name: "Mountain").first, secondary_terrain: Terrain.where(name: "Res Akhani").first )
Province.find(20).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Coast").first, secondary_terrain: Terrain.where(name: "Hills").first )
Province.find(21).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Rocky").first, secondary_terrain: Terrain.where(name: "River").first )
Province.find(22).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "River").first )
Province.find(23).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Mountains").first, secondary_terrain: Terrain.where(name: "Mountains").first )
Province.find(24).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Dirt").first )
Province.find(25).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Mud").first, secondary_terrain: Terrain.where(name: "Coast").first )
Province.find(26).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Mud").first, secondary_terrain: Terrain.where(name: "Coast").first )
Province.find(27).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Coast").first )
Province.find(28).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Rocky").first )
Province.find(29).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Rocky").first )
...
Province.find(31).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Mountains").first, secondary_terrain: Terrain.where(name: "Mountains").first )
Province.find(32).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Mountains").first, secondary_terrain: Terrain.where(name: "Mountains").first )
Province.find(33).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Mountains").first, secondary_terrain: Terrain.where(name: "Mountains").first )
Province.find(34).update(name:"Mountains of Ulog", primary_terrain: Terrain.where(name: "Mountains").first, secondary_terrain: Terrain.where(name: "Mountains").first )
Province.find(35).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Mountains").first, secondary_terrain: Terrain.where(name: "Hills").first )
Province.find(36).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Mountains").first, secondary_terrain: Terrain.where(name: "Mountains").first )
Province.find(37).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Mountain").first, secondary_terrain: Terrain.where(name: "Hills").first )
Province.find(38).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Hills").first )
Province.find(39).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Rocky").first )
Province.find(40).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Mountains").first, secondary_terrain: Terrain.where(name: "Hills").first )
Province.find(41).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Dirt").first )
Province.find(42).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Mud").first )
Province.find(43).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Grassland").first, secondary_terrain: Terrain.where(name: "Forest").first )
Province.find(44).update(name:"Mere of Lagash", primary_terrain: Terrain.where(name: "Mud").first, secondary_terrain: Terrain.where(name: "Lake").first )
Province.find(45).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Mud").first, secondary_terrain: Terrain.where(name: "Dirt").first )
...
Province.find(47).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Elysian").first, secondary_terrain: Terrain.where(name: "Hills").first )
Province.find(48).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Hills").first )
Province.find(49).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Rocky").first, secondary_terrain: Terrain.where(name: "Hills").first )
Province.find(50).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Hills").first, secondary_terrain: Terrain.where(name: "River").first )
Province.find(51).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Rocky").first, secondary_terrain: Terrain.where(name: "Coast").first )
Province.find(52).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Rocky").first, secondary_terrain: Terrain.where(name: "Coast").first )
Province.find(53).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Coast").first, secondary_terrain: Terrain.where(name: "Dirt").first )
Province.find(54).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Coast").first, secondary_terrain: Terrain.where(name: "Dirt").first )
Province.find(55).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Coast").first )
Province.find(56).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Coast").first, secondary_terrain: Terrain.where(name: "Mud").first )
Province.find(57).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Mud").first, secondary_terrain: Terrain.where(name: "Coast").first )
Province.find(58).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Rocky").first, secondary_terrain: Terrain.where(name: "Coast").first )
Province.find(59).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Rocky").first, secondary_terrain: Terrain.where(name: "Hills").first )
Province.find(60).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Hills").first )
Province.find(61).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Coast").first, secondary_terrain: Terrain.where(name: "Rocky").first )
Province.find(62).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Mud").first, secondary_terrain: Terrain.where(name: "Coast").first )
Province.find(63).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Hills").first, secondary_terrain: Terrain.where(name: "Plains").first )
Province.find(64).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Rocky").first )
Province.find(65).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Hills").first, secondary_terrain: Terrain.where(name: "Rocky").first )
Province.find(66).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Hills").first, secondary_terrain: Terrain.where(name: "Dirt").first )
Province.find(67).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Rocky").first, secondary_terrain: Terrain.where(name: "River").first )
Province.find(68).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Rocky").first, secondary_terrain: Terrain.where(name: "Hills").first )
Province.find(69).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Rocky").first, secondary_terrain: Terrain.where(name: "River").first )
Province.find(70).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Hills").first )
Province.find(71).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Lake").first, secondary_terrain: Terrain.where(name: "Dirt").first )
Province.find(72).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Dirt").first )
Province.find(73).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Hills").first, secondary_terrain: Terrain.where(name: "River").first )
Province.find(74).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Rocky").first, secondary_terrain: Terrain.where(name: "River").first )
Province.find(75).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Mud").first )
Province.find(76).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Mud").first, secondary_terrain: Terrain.where(name: "Lake").first )
Province.find(77).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Rocky").first )
Province.find(78).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Coast").first )
Province.find(79).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Coast").first, secondary_terrain: Terrain.where(name: "Elysian").first )
Province.find(80).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Rocky").first, secondary_terrain: Terrain.where(name: "River").first )
Province.find(81).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Mud").first, secondary_terrain: Terrain.where(name: "Coast").first )
Province.find(82).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Rocky").first, secondary_terrain: Terrain.where(name: "Coast").first )
Province.find(83).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Rocky").first, secondary_terrain: Terrain.where(name: "Dirt").first )
Province.find(84).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Rocky").first, secondary_terrain: Terrain.where(name: "Dirt").first )
Province.find(85).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Coast").first )
Province.find(86).update(name:"Lake of Steam", primary_terrain: Terrain.where(name: "Freshwater Sea").first, secondary_terrain: Terrain.where(name: "Freshwater Sea").first )
Province.find(87).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Dirt").first, secondary_terrain: Terrain.where(name: "Coast").first )
Province.find(88).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Rocky").first )
Province.find(89).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(90).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(91).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(92).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(93).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(94).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(95).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(96).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(97).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(98).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(99).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(100).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(101).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(102).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(103).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(104).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(105).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(106).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Ocean").first )
Province.find(107).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Ocean").first, secondary_terrain: Terrain.where(name: "Hills").first )
Province.find(108).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
Province.find(109).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
Province.find(110).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
Province.find(111).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
Province.find(112).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
Province.find(113).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
Province.find(114).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
Province.find(115).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
Province.find(116).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
Province.find(117).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
Province.find(118).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
Province.find(119).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
Province.find(120).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
Province.find(121).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
Province.find(122).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
Province.find(123).update(name:"Province#{self.id}", primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
Province.find(124).update(name:"South Terminus", primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
Province.find(125).update(name:"North Terminus", primary_terrain: Terrain.where(name: "Glacier").first, secondary_terrain: Terrain.where(name: "Glacier").first )
